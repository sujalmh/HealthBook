    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-base font-bold text-slate-100">Prescribed Clinical Calendar</h3>
      ...
      {filteredEvents.length === 0 ? (
        <div className="bg-slate-900/40 border border-slate-800 rounded-3xl p-8 text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">No scheduled events in this category.</p>
        </div>
      ) : (
              ...
              >
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-400">{evt.reason}</p>
