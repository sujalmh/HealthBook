      ...
      <div className="bg-canvas-card border border-canvas-border rounded-2xl max-w-xl w-full shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-canvas-border bg-canvas-card">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-sky-50 text-clinical-blue flex items-center justify-center border border-sky-200 shadow-sm">
              <Calendar className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-heading-md text-slate-900">Order direct clinical follow-up</h3>
              <p className="text-body-sm text-muted">Prescribe urgent in-person or telehealth review</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center gap-2.5 p-3 rounded-xl border text-body-sm font-bold transition-all ${
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <button
                  ...
                  className={`py-2 px-2 rounded-xl text-body-sm font-bold border transition-colors ${
                    dateOffset === opt.id
          ...
          <div className="bg-canvas-muted rounded-xl p-3 border border-canvas-border flex items-center justify-between text-body-sm text-muted">
            <span className="flex items-center gap-2">
              <Bell className="w-4 h-4 text-clinical-amber" />
