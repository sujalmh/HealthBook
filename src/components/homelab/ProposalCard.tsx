    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h4 className="text-base font-bold text-slate-100">{proposal.doctorName || 'Dr. Anita Patel, MD'}</h4>
          </div>
        </div>
      ...
      <div className="bg-slate-950/80 rounded-2xl p-4 border border-slate-800 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
          ...
          <div className="bg-slate-900/90 rounded-xl p-3.5 border border-slate-800 space-y-1">
            ...
            <div className="text-sm font-black text-slate-300 line-through">
              {proposal.previousDose || '1000 mg BID (Morning & Evening)'}
            </div>
            <span className="text-[11px] text-slate-500">2 tablets daily</span>
          </div>

          {/* Proposed Dose */}
          <div className="bg-emerald-950/30 rounded-xl p-3.5 border border-emerald-500/40 space-y-1 relative overflow-hidden">
      ...
      <div className="space-y-3">
        {proposal.linkedLabId && (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-rose-500/10 border border-rose-500/20 text-xs font-semibold text-rose-300">
            <AlertCircle className="w-4 h-4 text-rose-400" />
            <span>Triggered by Lab Result: eGFR = 28 mL/min (Reported Aug 28)</span>
          </div>
        )}

        <div className="bg-slate-950/50 rounded-2xl p-4 border border-slate-800/80 space-y-2">
      ...
      {isPending ? (
        <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-slate-800 hover:bg-rose-950/40 text-slate-400 hover:text-rose-300 text-xs font-semibold border border-slate-700 hover:border-rose-500/40 transition-colors"
            >
              Reject Change
            </button>
          </div>
        ...
        <div className="bg-emerald-950/20 border border-emerald-500/30 rounded-2xl p-3 text-xs text-emerald-300 flex items-center justify-between">
