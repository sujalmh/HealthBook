...
import { Eye, Check, X, Edit3, Sparkles, FileText, CheckCircle, X as XIcon, Copy, ShieldCheck, AlertTriangle, Search } from 'lucide-react';
  ...
  return (
    <div className="w-full space-y-6 animate-fade-in">
        ...
        <div className="w-full bg-white border border-amber-200 rounded-xl shadow-sm overflow-hidden">
          <div className="px-3 sm:px-4 py-3 border-b border-amber-100 bg-amber-50/60 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="text-caption text-amber-800/80">Check before they update medicines and labs.</p>
            </div>
      ...
      {!isLoading && pendingFacts.length === 0 && facts.length > 0 && (
        <p className="text-xs font-semibold text-emerald-800 bg-emerald-50 border border-emerald-200 rounded-xl px-3 py-2">All reviewed — nothing pending.</p>
      )}
      ...
      <div className="w-full bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        ...
        {labDelegationActive ? (
          ...
          <div className="p-6 text-center bg-slate-50/50">
            <p className="text-sm font-semibold text-slate-700">No records yet — add a paper above.</p>
          </div>
        ) : (
          <div className="overflow-x-auto scrollbar-none">
            <table className="w-full text-left text-body-sm min-w-[760px]">
