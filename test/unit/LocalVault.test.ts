...
import { Fact, MedicationRecord, LabRecord, ProposalRecord, LinkedCareProfile, DoctorAccessGrant } from '@/types/vault';
...
describe('Privacy-First LocalVault (11 Object Stores & In-Memory Engine)', () => {
  ...
  it('manages care circle and doctor grants', async () => {
    const member: LinkedCareProfile = {
      linkId: 'circle-1',
      patientId: testPatientId,
      patientName: 'Smt. Shanti Devi',
      caregiverId: 'user-raj',
    ...
    const grant: DoctorAccessGrant = {
      ...
      doctorEmail: 'dr.chen@cardio.org',
      durationDays: 7,
      scope: 'full_dossier',
